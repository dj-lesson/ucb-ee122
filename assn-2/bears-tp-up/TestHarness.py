...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, PacketCheckErrTest, AllCaseTest
# if os = Windows
    # BasicTest.BasicTest(forwarder, "README-GBK")
    RandomDropTest.RandomDropTest(forwarder, "README-GBK")
    # PacketCheckErrTest.PacketCheckErrTest(forwarder, "README-GBK")
    # AllCaseTest.AllCaseTest(forwarder, "README-GBK")
# if os = Linux
    # BasicTest.BasicTest(forwarder, "README")
    # RandomDropTest.RandomDropTest(forwarder, "README")
    # PacketCheckErrTest.PacketCheckErrTest(forwarder, "README")
    # AllCaseTest.AllCaseTest(forwarder, "README")
